<template>
  <div class="app-page tenant-login-page" :style="loginPageStyle">
    <div class="login-card">
      <div class="brand-area">
        <h1 class="brand-title">{{ oemTitle }}</h1>
        <p class="brand-subtitle">{{ t('benefit.tenant-login') }}</p>
      </div>
...
defineOptions({ name: 'TenantLoginPage' })
...
async function handleLogin() {
  ...
  try {
    ...
    router.replace('/benefit/tenant/app/dashboard')
  } catch (err: any) {
