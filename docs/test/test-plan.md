...
> 版本：V1.0 基线 ｜ 更新：2026-09-18 ｜ 依据代码实跑口径（surefire/it-summary/playwright）生成
...
| L6 | 平台治理与租户生命周期 | 建租户（secret 一次性返回）、email 唯一、SUSPEND/RESUME/CLOSE 生命周期、reset-secret 双版本宽限、平台跨租户概览、平台域闸、tenant TCK 合规、签名密钥管理 |
